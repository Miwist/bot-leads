...
> = {
  ...
  growth: {
    ...
    features: [
      ...
      "Telegram-бот: распознавание голосовых, смысл фото и PDF через Timeweb Cloud AI (при настроенном ИИ)",
      "Удобнее при нескольких менеджерах и стабильном потоке лидов",
